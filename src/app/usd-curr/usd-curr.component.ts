...
@Component({
  selector: 'app-usd-curr',
  templateUrl: './usd-curr.component.html',
  styleUrls: ['./usd-curr.component.css']
})
export class USDCurrComponent implements OnInit {
  ...
  url_:string ="https://www.alphavantage.co/query?function=FX_INTRADAY&from_symbol=EUR&to_symbol=USD&interval=5min&&apikey=85D3HVNRSASR3WTJ";
users_: any[];
randomnum : any = (Math.random() * (10.00 - 1.00 + 1.00) + 1.00).toFixed(2);
randomnum1 : any = (Math.random() * (10.00 - 1.00 + 2.00) + 1.00).toFixed(2);
