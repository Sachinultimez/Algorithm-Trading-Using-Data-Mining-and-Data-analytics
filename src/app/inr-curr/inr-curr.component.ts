...
@Component({
  selector: 'app-inr-curr',
  templateUrl: './inr-curr.component.html',
  styleUrls: ['./inr-curr.component.css']
})
export class INRCurrComponent implements OnInit {
  ...
  source: any =
  {
    ...
    url: 'https://www.alphavantage.co/query?function=FX_INTRADAY&from_symbol=EUR&to_symbol=INR&interval=5min&&apikey=85D3HVNRSASR3WTJ&datatype=csv'
  };
  ...
  url_:string ="https://www.alphavantage.co/query?function=FX_INTRADAY&from_symbol=EUR&to_symbol=INR&interval=5min&&apikey=85D3HVNRSASR3WTJ";
users_: any[];
randomnum : any = (Math.random() * (11.00 - 1.00 + 1.00) + 1.00).toFixed(3);
randomnum1 : any = (Math.random() * (9.00 - 1.00 + 2.00) + 1.00).toFixed(1);
