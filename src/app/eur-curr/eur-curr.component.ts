...
@Component({
  selector: 'app-eur-curr',
  templateUrl: './eur-curr.component.html',
  styleUrls: ['./eur-curr.component.css']
})
export class EURCurrComponent implements OnInit {
  ...
  url_:string ="https://www.alphavantage.co/query?function=FX_INTRADAY&from_symbol=EUR&to_symbol=SGD&interval=5min&&apikey=85D3HVNRSASR3WTJ";
users_: any[];
