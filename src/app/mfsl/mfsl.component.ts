...
@Component({
  selector: 'app-mfsl',
  templateUrl: './mfsl.component.html',
  styleUrls: ['./mfsl.component.css']
})
export class MFSLComponent implements OnInit {
  ...
  url_:string ="https://www.alphavantage.co/query?function=TIME_SERIES_INTRADAY&symbol=MSFT&interval=5min&&apikey=85D3HVNRSASR3WTJ";
users_: any[];
randomnum : any = (Math.random() * (10.00 - 1.00 + 8.00) + 1.00).toFixed(2);
randomnum1 : any = (Math.random() * (10.00 - 1.00 + 4.00) + 1.00).toFixed(1);
